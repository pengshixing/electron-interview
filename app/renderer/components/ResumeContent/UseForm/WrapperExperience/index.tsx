...
type EditModalType = {
  showByCancel?: boolean; // 编辑下的取消弹窗
  showBySave?: boolean; // 编辑下的保存弹窗
  status?: boolean; // 编辑的状态
  tempSaveItem?: Record<string, any>; // 暂时保存的数据
  onAfterFn?: () => void; // 操作之后的执行方法
};
...
const defaultEditModal = {
  ...
  status: false, // 编辑的状态
  tempSaveItem: {} as Record<string, any>, // 暂时保存的数据
  onAfterFn: () => {}, // 操作之后的执行方法
} as EditModalType;
